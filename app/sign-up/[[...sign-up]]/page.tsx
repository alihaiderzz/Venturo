    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F6F7F9] to-[#E5E7EB] flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#0B1E3C] mb-2">Join Venturo</h1>
          <p className="text-[#6B7280]">Create your Venturo account</p>
        </div>
        ...
        <SignUp 
          appearance={{
            elements: {
              headerTitle: {
                display: 'none', // Hide the default "Sign up" title
              },
              headerSubtitle: {
